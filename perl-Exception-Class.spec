%{?scl:%scl_package perl-Exception-Class}

Name:           %{?scl_prefix}perl-Exception-Class
Version:        1.44
Release:        8%{?dist}
...
BuildRequires:  %{?scl_prefix}perl(Class::Data::Inheritable) >= 0.02
BuildRequires:  %{?scl_prefix}perl(Devel::StackTrace) >= 2.00
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 1.44-8
- SCL
